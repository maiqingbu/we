  ...
  return (
    <div className="shrink-0 border-b border-border bg-background">
      ...
      >
        ...
        <span data-foldable="color" className="contents">
          <ColorGroup editor={editor} />
          <Separator orientation="vertical" className="mx-1 h-6 shrink-0" />
        </span>

        <span data-foldable="align" className="contents">
          <AlignGroup editor={editor} />
          <Separator orientation="vertical" className="mx-1 h-6 shrink-0" />
        </span>

        <span data-foldable="list" className="contents">
          <ListGroup editor={editor} />
          <Separator orientation="vertical" className="mx-1 h-6 shrink-0" />
        </span>

        <span data-foldable="block" className="contents">
          <BlockGroup editor={editor} />
          <Separator orientation="vertical" className="mx-1 h-6 shrink-0" />
        </span>

        <span data-foldable="insert" className="contents">
          <InsertGroup editor={editor} />
        </span>

        <span data-foldable="table" className="contents">
          <TableGridSelector editor={editor} />
        </span>

        <span data-foldable="more" className="contents">
          <Separator orientation="vertical" className="mx-1 h-6 shrink-0" />
